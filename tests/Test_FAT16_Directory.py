...
class TestFAT16RootDirectory(unittest.TestCase):
    ...
    def testGetStringFromLongFilename(self):
        testString = Directory.getStringFromLongFilename([int(0x74),int(0x00),int(0x65),int(0x00),int(0x73),int(0x00),int(0x74),int(0x00),int(0x00),int(0x00)],[int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff),int(0xff)],[int(0xff),int(0xff),int(0xff),int(0xff)])
